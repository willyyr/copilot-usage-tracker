...
```
═══ All-Time Usage ═══
Sessions: 42  |  API calls: 1,337  |  Premium requests (cost): 892.0
Total tokens → Input: 12,450,000  Output: 3,200,000  Cache-read: 8,100,000  Cache-write: 1,050,000

Model                           Calls      Cost     Input Tok    Output Tok    Cache Read   Cache Write
──────────────────────────────────────────────────────────────────────────────────────────────────────────
claude-opus-4.6                    89     267.0     4,200,000     1,800,000     3,100,000       450,000
claude-sonnet-4.5                 420     420.0     5,100,000       900,000     3,500,000       380,000
gpt-5.1-codex                    328     164.0     2,800,000       400,000     1,200,000       180,000
claude-haiku-4.5                  500      41.0       350,000       100,000       300,000        40,000
```
